...
foreach ($files as $fname) {
	...
	foreach ($file as $line) {
		...
		$l=strtolower($l);
		$l=idn_to_ascii($l);
		if (preg_match("/^(2([0-4][0-9]|5[0-5])|1[0-9][0-9]|[1-9][0-9]|[0-9])\.(2([0-4][0-9]|5[0-5])|1[0-9][0-9]|[1-9][0-9]|[0-9])\.(2([0-4][0-9]|5[0-5])|1[0-9][0-9]|[1-9][0-9]|[0-9])\.(2([0-4][0-9]|5[0-5])|1[0-9][0-9]|[1-9][0-9]|[0-9])$/",$l) && !in_array($l,$ips_unlock)) {
			$ips[]=$l;
		}
